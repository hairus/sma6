...
<div class="container">
    ...
    <div class="row">
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" enctype="multipart/form-data" method="post" action="simpanUpload">
                {{csrf_field()}}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="mapel" class="form-control">
                            ...
                            @endforeach
                            <option value="0"> Bank Data </option>
                        </select>
                    </div>
                ...
                <table class="table table-condensed">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ url('/guru/del/'.$data->id) }}" method="post">
                                    {{csrf_field() }}
                                    <button class="btn btn-danger" type="submit" name="button"><i class="fa fa-trash-o" aria-hidden="true"></i> Hapus</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
