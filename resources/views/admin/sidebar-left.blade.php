<ul class="sidebar-menu">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li>
                <a href="#"><i class="fa fa-gear"></i> Mapping TA Baru
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="{{ url('/admin/key')}}"><i class="fa fa-circle-o"></i>Key API</a></li>
                    <li><a href="{{ url('/admin/cAta')}}"><i class="fa fa-circle-o"></i>TA</a></li>
                    <li><a href="{{ url('/admin/updatePpd')}}"><i class="fa fa-circle-o"></i>Update Mapel PPD</a></li>
                    <li><a href="{{ url('/admin/csb')}}"><i class="fa fa-circle-o"></i>Create Siswa Baru</a></li>
                    <li><a href="{{ url('/admin/ds')}}"><i class="fa fa-circle-o"></i>Hapus siswa</a></li>
                    <li><a href="{{ url('/admin/micro1')}}"><i class="fa fa-circle-o"></i>MICRO</a></li>
                    <li><a href="{{ url('/admin/asisten')}}"><i class="fa fa-circle-o"></i>Role TPK</a>
                    </li>
                    <li><a href="{{ url('/admin/teva')}}"><i class="fa fa-circle-o"></i>Role Tim Evaluasi</a></li>
                    <li><a href="{{ url('/admin/mapKel')}}"><i class="fa fa-circle-o"></i>Maping Mapel Kelas</a></li>
                </ul>
            </li>
            <li>
    ...
    <li class="treeview" style="height: auto;">
        <a href="#">
            <i class="fa fa-share"></i> <span>Siswa Baru</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
        </a>
        <ul class="treeview-menu" style="display: none;">
            <li class="treeview" style="height: auto;">
                <a href="#"><i class="fa fa-circle-o"></i> Kelengkapan Siswa
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu" style="display: none;">
                    <li><a href="{{ url('/admin/cek')}}"><i class="fa fa-circle-o"></i>Cek Siswa Baru</a></li>
                    <li><a href="{{ url('/admin/sibaMipa')}}"><i class="fa fa-circle-o"></i>Peminatan Mipa</a></li>
                    <li><a href="{{ url('/admin/sibaIps')}}"><i class="fa fa-circle-o"></i>Peminatan Ips</a></li>
                    <li><a href="{{ url('/admin/stin')}}"><i class="fa fa-circle-o"></i>Siswa Tidak Input Nilai</a></li>
                    <li><a href="{{ url('/admin/skn')}}"><i class="fa fa-circle-o"></i>Siswa Nilai Tidak Lengkap</a>
                    </li>
                    <li><a href="{{ url('/admin/stib')}}"><i class="fa fa-circle-o"></i>Siswa Tidak Input Biodata</a>
                    <li><a href="{{ url('/admin/DelNilai')}}"><i class="fa fa-circle-o"></i>Delete Nilai</a></li>
                    <li><a href="{{ url('/admin/klsSiswa')}}"><i class="fa fa-circle-o"></i>Kelas Siswa</a></li>
            </li>
        </ul>
    </li>
    <li class="treeview" style="height: auto;">
        <a href="#"><i class="fa fa-circle-o"></i> Koperasi
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
            </span>
        </a>
        <ul class="treeview-menu" style="display: none;">
            <li>
                <a href="{{ url('/admin/koperasi')}}"><i class="fa fa-circle-o"></i>Data Upload Siswa Baru</a>
            </li>
        </ul>
    </li>
</ul>
...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        <li><a href="{{'/admin/isurat'}}"><i class="fa fa-circle-o"></i>Surat</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
    ...
    <ul class="treeview-menu">
        ...
        <li><a href="{{'/admin/perangkat'}}"><i class="fa fa-circle-o"></i> Rekap Perangkat (RPP/SILABUS)</a></li>
        <li><a href="{{'/admin/notPerangkat'}}"><i class="fa fa-circle-o"></i> Rekap Perangkat (Ekstra/Waka)</a>
        </li>
        <li><a href="{{'/admin/Rjurnal'}}"><i class="fa fa-circle-o"></i> Rekap Jurnal/Guru</a></li>
        <li><a href="{{'/admin/absen/IrekapGuru'}}"><i class="fa fa-circle-o"></i> Rekap Guru Bulan
                {{ date('F') }}</a></li>
        <li><a href="{{ '/admin/rIndexG' }}"><i class="fa fa-circle-o"></i> Rekap Guru Harian</a></li>
        <li><a href="{{ '/admin/indexKelas' }}"><i class="fa fa-circle-o"></i> Pindah Kelas</a></li>
        <li><a href="{{ '/admin/mutasi' }}"><i class="fa fa-circle-o"></i> Mutasi Siswa</a></li>
        <li><a href="{{ '/admin/SiswaAbsen' }}"><i class="fa fa-circle-o"></i>List Siswa A</a></li>
        <li><a href="{{ '/admin/addSsisA' }}"><i class="fa fa-circle-o"></i>Input Siswa XII/XI</a></li>
        <li><a href="{{ '/admin/SetGU' }}"><i class="fa fa-circle-o"></i>Set Ukmb Guru</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
    ...
    <ul class="treeview-menu">
        ...
        <li><a href="{{ '/admin/cekGP' }}"><i class="fa fa-circle-o"></i> Cek Guru Profile</a></li>
        <li><a href="{{'/admin/jurnal' }}"><i class="fa fa-circle-o"></i> Jurnal</a></li>
        <li><a target="_blank" href="http://rapot.sumenepsmansa.sch.id"><i class="fa fa-circle-o"></i> Rapor
                Online</a></li>
        <li><a href="{{ '/admin/upload' }}"><i class="fa fa-circle-o"></i> Upload Perangkat</a></li>
        <li><a href="{{ '/admin/UpUm' }}"><i class="fa fa-circle-o"></i> Upload Umum</a></li>
        <li><a href="{{ '/admin/pm' }}"><i class="fa fa-circle-o"></i>Pilih Mapel</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
    ...
    <ul class="treeview-menu">
        <li><a href="{{'/admin/quiz/penelaah'}}"><i class="fa fa-circle-o"></i>Guru Penelaah</a></li>
        <li><a href="{{'/admin/quiz'}}"><i class="fa fa-circle-o"></i>Setting</a></li>
        <li><a href="{{'/admin/eva/Csoal'}}"><i class="fa fa-circle-o"></i>Soal</a></li>
        <li><a href="{{'/admin/eva/test'}}"><i class="fa fa-circle-o"></i>test</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
    ...
    <ul class="treeview-menu">
        ...
        <li><a href="{{url('/admin/AdminAbsen/cetak/kelas')}}"><i class="fa fa-circle-o"></i> Cetak Absen Hari
                Ini</a></li>
        <li><a href="{{url('/admin/AdminAbsen/RGB')}}"><i class="fa fa-circle-o"></i> Rekap Guru Bulanan</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
    ...
    <ul class="treeview-menu">
        <li><a href="{{url('admin/Fpoin')}}"><i class="fa fa-circle-o"></i>Input Poin Siswa</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
    ...
    <ul class="treeview-menu" style="display: none;">
        <li class="treeview">
            <a href="#"><i class="fa fa-book"></i> PKPD
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
            <ul class="treeview-menu">
                <li><a href="{{url('/admin/sks/setKd')}}"><i class="fa fa-circle-o"></i>Set KD</a></li>
                <li><a href="{{url('/admin/sks/listKd')}}"><i class="fa fa-circle-o"></i>List KD</a></li>
                <li><a href="{{url('/admin/sks/fmkls')}}"><i class="fa fa-circle-o"></i>PPD</a></li>
                <li><a href="{{ url('admin/sks/eximp') }}"><i class="fa fa-circle-o"></i>Import Excel</a></li>
                <li><a href="{{ url('admin/sks/cekPro') }}"><i class="fa fa-circle-o"></i>Cek Profile Siswa</a></li>
                <li><a href="{{ url('/admin/sks/npk') }}"><i class="fa fa-circle-o"></i>Cek Nilai Mapel</a></li>
            </ul>
        </li>
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li><a href="{{url('/admin/sks/showKelasSks')}}"><i class="fa fa-circle-o"></i>Nilai Ukbm</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i>Nilai Akhir </a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i>Nilai Semester </a></li>
            </ul>
        </li>
    </ul>
    <ul class="treeview-menu">
        <li><a href=""><i class="fa fa-circle-o"></i>Pembuatan KD</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
    ...
    <ul class="treeview-menu">
        <li><a href="{{ url('/admin/penH')}}"><i class="fa fa-circle-o"></i>protoType Penilaian Harian</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="#">
...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        <li><a href="/admin/showlist"><i class="fa fa-circle-o"></i>Password Guru</a></li>
        <li><a href="/smansa/public/admin/showlistsiswa"><i class="fa fa-circle-o"></i>Password Siswa</a></li>
        <li><a href="/smansa/public/admin/resetSiswaAll"><i class="fa fa-circle-o"></i>Reset Password Siswa All</a></li>
        <li><a href="#"><i class="fa fa-circle-o"></i>Password Tu</a></li>
    </ul>
</li>
<li class="treeview">
    <a href="{{url('admin/AdminAbsen/form')}}">
        <i class="fa fa-key"></i>
        <span>Ubah Password</span>
    </a>
</li>
<li class="treeview">
    <a href="{{url('/admin/cRole')}}">
