...
@section('content')
  ...
  <!-- disini memberikan space atau tempat untuk menampilkan notif -->
    ...
    <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" enctype="multipart/form-data" method="post" action="/{{ $user }}/sks/saveUp">
                {{csrf_field()}}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select name="kelas" class="form-control">
                    ...
                    <option value="{{ $mapel->kat_kelas }}">{{ $mapel->kat_kelas }}</option>
                    @endforeach
                  </select>
                </div>
                <div class="form-group">
        ...
        @foreach($UpPems as $UpPem)
                <tr>
                  ...
                  <td><form action="/{{$user}}/sks/hapusUpload/{{$UpPem->id}}" method="post">
                        {{csrf_field() }}
